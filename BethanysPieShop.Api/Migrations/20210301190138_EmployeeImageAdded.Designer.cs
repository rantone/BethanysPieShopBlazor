...
namespace BethanysPieShop.Api.Migrations
{
    ...
    [Migration("20210301190138_EmployeeImageAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Employee", b =>
                {
                    b.HasOne("BethanysPieShop.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPieShop.Shared.JobCategory", "JobCategory")
                        .WithMany()
